        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountDbLogin = table.Column<string>(nullable: true),
                    AccountDbPassword = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AchievementDbId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Achievement", x => x.AchievementDbId);
                    table.ForeignKey(
                        name: "FK_Achievement_Player_OwnerDbId",
